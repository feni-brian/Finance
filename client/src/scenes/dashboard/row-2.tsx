			...
			<DashboardBox gridArea="d">
				...
				<ResponsiveContainer width="100%" height="100%">
					...
					>
						<CartesianGrid
							vertical={false}
							stroke={palettes.palette.grey.semiblack}
						/>
						<XAxis
							dataKey="name"
							tickLine={false}
						...
						<Line
							...
							stroke={palettes.palette.tertiary.main}
						/>
						<Line
							yAxisId="right"
							type="monotone"
							dataKey="Operational Expenses"
							stroke={palettes.palette.primary.semidark}
						/>
					</LineChart>
				</ResponsiveContainer>
			</DashboardBox>
				...
				<FlexBetween mt="0.25rem" gap="1.5rem" pr="1rem">
					...
					<Box ml="-0.7rem" flexBasis="40%" textAlign="center">
						...
						<Typography
							m="0.3rem 0"
							variant="h3"
							color={palettes.palette.primary.semidark}
						>
							83
						</Typography>
						<Typography variant="h6">
							Finance goals of the desire campaign
						</Typography>
					</Box>
					<Box flexBasis="40%">
			...
			<DashboardBox gridArea="f">
				...
				<ResponsiveContainer width="100%" height="100%">
					<ScatterChart margin={{ top: 20, right: 25, bottom: 40, left: -10 }}>
						<CartesianGrid stroke={palettes.palette.grey.semiblack} />
						<XAxis
							type="number"
							dataKey="price"
							name="price"
						...
						<Scatter
							...
							fill={palettes.palette.primary.semidark}
						/>
					</ScatterChart>
				</ResponsiveContainer>
			</DashboardBox>
